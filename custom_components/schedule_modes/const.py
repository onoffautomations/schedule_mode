...
# Custom calendars - user-defined calendar names
OPT_CUSTOM_CALENDARS    = "custom_calendars"
...
def ensure_default_options(opts: Dict) -> Dict:
    ...
    out.setdefault(OPT_CUSTOM_CALENDARS, [])
    # Ensure custom calendars is a list and normalize format
    if not isinstance(out[OPT_CUSTOM_CALENDARS], list):
        out[OPT_CUSTOM_CALENDARS] = []
    out[OPT_CUSTOM_CALENDARS] = normalize_custom_calendars(out[OPT_CUSTOM_CALENDARS])
    return out
